...
function HeroBackground(props) {
  return (
    <Svg viewBox="0 0 3717.94 1371.78" {...props}>
      <defs>
        <style>
          {
            ".prefix__cls-2{fill:#eff195}.prefix__cls-3{fill:#1de9b6}.prefix__cls-4{fill:#ffc9e7}.prefix__cls-5{fill:#ff4874}.prefix__cls-6{fill:#f0efe2}"
          }
        </style>
      </defs>
      ...
      <g id="prefix__Layer_2" data-name="Layer 2">
        <g id="prefix__sugar">
          ...
          <rect
            ...
            rx={3.5}
            ry={3.5}
            transform="rotate(-109.73 1982.121 374.317)"
          />
          <rect
            className="prefix__cls-3"
            x={2180.97}
          ...
          <path
            className="prefix__cls-2"
            d="M903.54 240.3a3.65 3.65 0 01-1.87 4.48l-21.8 8.84a3 3 0 01-4-2.11 3.65 3.65 0 011.87-4.48l21.8-8.84a3 3 0 014 2.11z"
          />
          <path
            className="prefix__cls-3"
            d="M823.57 252.66a3.62 3.62 0 012 4.39l-7 25a3.05 3.05 0 01-3.88 2.29 3.62 3.62 0 01-2-4.39l7-25a3.05 3.05 0 013.88-2.29z"
          />
          <path
            className="prefix__cls-4"
            d="M792.33 243.28a3.43 3.43 0 012.76 3.84l-2.36 26.05a3.23 3.23 0 01-3.39 3.13 3.43 3.43 0 01-2.76-3.84l2.36-26.05a3.23 3.23 0 013.39-3.13z"
          />
          <path
            className="prefix__cls-5"
            d="M773.25 281.85a2.88 2.88 0 014.31.85l13.34 21.41a3.81 3.81 0 01-.75 4.88 2.88 2.88 0 01-4.31-.85l-13.34-21.41a3.81 3.81 0 01.75-4.88z"
          />
          <path
            className="prefix__cls-6"
            d="M749 291.44a2.94 2.94 0 014.18 1.49l10.71 23.22a3.75 3.75 0 01-1.31 4.72 2.94 2.94 0 01-4.18-1.49l-10.71-23.22a3.75 3.75 0 011.31-4.72z"
          />
          <rect
            className="prefix__cls-2"
            x={674.67}
          ...
          <rect
            ...
            rx={3.5}
            ry={3.5}
            transform="rotate(70.27 2930.928 646.056)"
          />
          <rect
            className="prefix__cls-3"
            x={2857.24}
